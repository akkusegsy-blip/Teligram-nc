...
OWNER_ID = int(os.getenv("OWNER_ID", "7879852447"))
BOT_TOKENS = [
    os.getenv("BOT_TOKEN_1", "8631144763:AAEJIBkPa4jLp1NlZHw3pKg1JLRlQDChpmU"),
    os.getenv("BOT_TOKEN_2", "8280354584:AAFbZyeSQ8uTrN0QoI3U616RfdEYCsZ37cc"),
    os.getenv("BOT_TOKEN_3", "8693575157:AAHbU7JRBPT_bJB-1mO9cXTDFNc19HD8KMA"),
    os.getenv("BOT_TOKEN_4", "8623495016:AAHjbL9WB4cQCqGGKl2I5zXY7zMX7OptuUw"),
    os.getenv("BOT_TOKEN_5", "8787248227:AAF2B_yY1Mduo8_WNDaV5reNqIl625hcyk8"),
    os.getenv("BOT_TOKEN_6", "8774472085:AAFR37HKGF8fo0wpkEXYozPSTYd3IT9QONI"),
    os.getenv("BOT_TOKEN_7", "8616439832:AAF7RXq7uFApjN8x1pWJBythDoukuZHhotM"),
]
...
UNAUTHORIZED_MESSAGE = "𝐀𝐊𝐊𝐔 𝐏𝐀𝐏𝐀 𝐒𝐄 𝐁𝐈𝐊𝐇 𝐌𝐀𝐍𝐆 🤣🎀😻"

NAME_CHANGE_MESSAGES = [
    "AKKU TERA BAAP  🔥⃤⃟⃝🐦‍🔥『🚩』",
    "{target} TERI BHEN KA BHOSADA 🔥⃤⃟⃝🐦‍🔥『🚩』",
    "{target} TERI MAA AKKU KE LUND PR 🔥⃤⃟⃝🐦‍🔥『🚩』",
    "{target} TERI MAA KA BHOSADA CHUDA 🔥⃤⃟⃝🐦‍🔥『🚩』",
    "{target} TERI CHUDAYI BY AKKU PAPA 🔥⃤⃟⃝🐦‍🔥『🚩』",
...
REPLY_MESSAGES = [
    ...
    "{target} Cʜᴜᴅᴀ🦖🪽",
    "{target} Bᴏʟᴇ ᴀᴋᴋᴜ ᴘᴀᴘᴀ पिताश्री Mᴇʀɪ Mᴀ Cʜᴏᴅ Dᴏ",
    "{target} Kɪ Mᴀ Bᴏʟᴇ ᴀᴋᴋᴜ ᴘᴀᴘᴀ Sᴇ Cʜᴜᴅᴜɴɢɪ",
    ...
    "{target} ᴋɪ ᴍᴀ ᴋᴏ ᴄʜᴏᴅᴇ ᴀᴋᴋᴜ ᴘᴀᴘᴀ",
    "{target} ᴋɪ ᴍᴀ ᴅᴇᴠ ᴘᴀᴘᴀ ꜱᴇ ᴄʜᴜᴅᴇ",
    "{target} ᴀᴋᴋᴜ ᴘᴀᴘᴀ ꜱᴇ ᴄʜᴜᴅᴀ",
    "{target} CUDKE MARGYA",
    "{target} ɴᴇ ᴀᴋᴋᴜ ᴘᴀᴘᴀ ᴋᴏ ʙᴀᴀᴩ ʙɴᴀ ʟɪyᴀ",
    "{target} ʙᴏʟᴇ ᴀᴋᴋᴜ ᴘᴀᴘᴀ ᴩᴀᴩᴀ",
...
class BotInstance:
    ...
    async def start(self, update, context):
        ...
        help_text = f"""
𓆩 𝐁𝐎𝐓 {self.bot_number} 𓆪 - 𝐓𝐇𝐄 𝐆𝐑𝐄𝐀𝐓 𝐀𝐊𝐊𝐔'𝐒 𝐁𝐎𝐓 
